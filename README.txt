Compiling and running
  ...
  Obtain the source code and navigate to the directory containing this README file. Run the following two commands:

  cs3110 compile repl.ml
  cs3110 run repl.ml
...
Try running the following, while occasionally calling PRINT table to see the effects.
...
Note that the last line switches the database to the database saved in minimalDB.json.
