...
TEST "NO DB CREATE DATABASE valid caps" =
  is_database_result (fst (Parser.evaluate "CREATE DATABASE test_a"))

TEST "NO DB CREATE DATABASE valid lowercase" =
  is_database_result (fst (Parser.evaluate "create database test_b"))
...
TEST "EXIT valid caps" =
  is_parser_message (fst (Parser.evaluate_db (InternalRep.reset db)
    "EXIT"))
...
TEST "CREATE DATABASE invalid no params" =
  is_parser_fail (fst (Parser.evaluate_db (InternalRep.reset db)
    "CREATE DATABASE"))

TEST "CREATE DATABASE valid caps" =
  is_database_result (fst (Parser.evaluate_db (InternalRep.reset db)
    "CREATE DATABASE test_c"))

TEST "CREATE DATABASE valid lowercase" =
  is_database_result (fst (Parser.evaluate_db (InternalRep.reset db)
